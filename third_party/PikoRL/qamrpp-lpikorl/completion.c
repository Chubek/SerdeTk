...
static qamrpp_value *
lpikorl_completion_native (qamrpp_context *ctx, qamrpp_value **argv, size_t argc)
{
...
lpikorl_completion_bindings (size_t *count)
{
  static const qamrpp_native_binding bindings[] = {
    { "lpicorl_completion", lpikorl_completion_native },
  };

...
static qamrpp_value *
lpikorl_directive_native (qamrpp_context *ctx, qamrpp_value **argv, size_t argc)
{
...
lpikorl_directive_bindings (size_t *count)
{
  static const qamrpp_native_binding bindings[] = {
    { "lpicorl_directive", lpikorl_directive_native },
  };

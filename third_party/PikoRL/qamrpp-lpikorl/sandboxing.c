...
static qamrpp_value *
lpikorl_sandboxing_native (qamrpp_context *ctx, qamrpp_value **argv, size_t argc)
{
...
lpikorl_sandboxing_bindings (size_t *count)
{
  static const qamrpp_native_binding bindings[] = {
    { "lpicorl_sandboxing", lpikorl_sandboxing_native },
  };

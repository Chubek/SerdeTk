...
static qamrpp_value *
lpikorl_prompt_native (qamrpp_context *ctx, qamrpp_value **argv, size_t argc)
{
  ...
  (void)argv;
  (void)argc;
  return host_api->value_string (ctx, "PicoRL> ", 8);
}

const qamrpp_native_binding *
lpikorl_prompt_bindings (size_t *count)
{
  static const qamrpp_native_binding bindings[] = {
    { "lpicorl_prompt", lpikorl_prompt_native },
  };
